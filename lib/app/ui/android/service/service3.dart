...
class _KakaoMapPageState extends State<KakaoMapPage> {
  ...
  Future<String> readJson1() async {
    ...
    http.Response res =
    await http.get(Uri.parse('http://kstbook1.dothome.co.kr/apt_json.php')); //2.5초
    //여기서 시간이 오래걸린다. 이걸 해결해야함. compute
    var time1 = (DateTime.now().millisecondsSinceEpoch - time0).toString();
    time1 = ' 시간: '+time1.substring(0,1)+'.'+time1.substring(1,2)+' 초';
    print(time1);
...
////////////////////////테스트용/////////////////////////
                      ...
                      //    console.log("테스트:",center,center.getLat(),center.getLng());
                      //    //cameraIdle.postMessage(center);
                      //});
////////////////////////////////////////////////////                      
                      var latlng;
                      var zIndex=1;
                    ...
                    ''',
                          ...
                          cameraIdle: (message) {
                            ...
                            print('current lat lng : ${latlng.lat}, ${latlng.lng}');
                        },
                        );
                      }
                    }),
